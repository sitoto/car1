...
#        next
  ...
  #http://db.auto.sohu.com/PARA/TRIMDATA/trim_data_101893.json
    ...
    @cars.each_with_index do |car , i|
      ...
      @file_to_write.puts "#{i} - #{json_html.length} - #{json_url}"
      next if json_html.length > 10000
...
sid = '1100' #it's bitauto 's  id :#http://db.auto.sohu.com/subbrand_1073/
maker = "本田"
folder = "s_jinkoubentian"
from_site = "sohu"
